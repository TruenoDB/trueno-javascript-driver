...
class RPC {
    ...
    call() {
        ...
        return new Promise((resolve, reject) => {
            ...
            upperArgs.push((args) => {
                ...
                switch (args._status) {
                    case Status.response.SUCCESS:
                        resolve(args._payload);
                        break;
                    case Status.response.ERROR:
                        reject(args._payload);
                        break;
                }
            });
    ...
    connect(connCallback, discCallback) {
        ...
        /* Listening for connections */
        this._socket = ioClient.connect(this._host + ':' + this._port, {reconnect: false});
