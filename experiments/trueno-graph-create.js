...
if( totalArguments == requiredArguments + 2){
  if (typeof process.argv[5] != "number") {
    console.log("[Warning] --> Numeric Port expected, default port (8007) used instead");
  }
  else {
...
ws.on("open", function open() {
  console.log("[Connected] --> Trueno Core");
  create();
});
